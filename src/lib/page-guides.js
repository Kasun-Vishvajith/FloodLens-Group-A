export const pageGuides={
 ...
 history:[
  ...
  ['Monthly & seasonal charts','Monthly comparison groups your selected days: rainfall is added up, other variables are averaged. Seasonal baseline shows typical daily values for each month in 2016 through the latest archived date, so its rain bars are not monthly totals.'],
