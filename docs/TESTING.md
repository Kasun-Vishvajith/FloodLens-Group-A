...
- `tests/react.test.mjs`: 25-location × route rendering, EDA and the integrated global explorer on Current & forecast, invalid date rejection, real-map fallback, filter scope, export scope, forecast date/month transitions, null gaps and unavailable flow handling.
